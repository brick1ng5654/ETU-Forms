...
---
# Документация
- `docs/API.md` - описание всех API эндпоинтов
- `docs/HTTPS.md` - руководство по работе с HTTPS
- `docs/Logging.md` - структура и настройки логирования
- `docs/FormElements.md` - обмен данными об элементах формы
- `docs/DB.md` - структура БД
- `docs/info_for_devs.md` - краткая информация для разработчиков
