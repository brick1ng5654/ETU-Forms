...
ETU-Forms - это веб-сервис для создания форм и опросов с использованием конструктора SurveyJS. Сервис позволяет создавать формы с различными типами полей, собирать и анализировать ответы, включая загрузку файлов, с интеграцией с ETU ID и etu.cloud.
